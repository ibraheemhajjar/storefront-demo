<template>
  <div class="product-item-container">
    ...
    <div class="product-details-container">
      <h3 class="product-details-title">{{ selectedProduct.title }}</h3>
      <p class="product-details-description">
        {{ selectedProduct.description.slice(0, 200) + " ..." }}
      </p>
      <p class="product-details-price">${{ selectedProduct.price }}</p>
      <ImageSlider :images="selectedProduct.images" @select="onImageSelected" />
      <div class="buttons-container">
        <button class="product-details-button">🛒 ADD TO CART</button>
        <button class="product-details-button">❤ ADD TO FAVORITE</button>
      </div>
    </div>
  </div>
</template>
...
const products = [
  {
    ...
    updatedAt: "2024-02-25T09:20:07.000Z",
    category: {
      id: 1,
      name: "Clothes",
